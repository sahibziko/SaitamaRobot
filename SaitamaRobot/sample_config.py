...
class Config(object):
    ...
    TOKEN = "1495875069:AAF9TSdEIwHxRhozbXf44Vjq_Ib1jHlqvFY"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 1419590194  # If you dont know, run the bot and do /id in your private chat with it, also an integer
